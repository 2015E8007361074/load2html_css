...
{ 	n:"无线设置", 
	s: "设置密码/网络名称/隐藏无线网",
	a: "set_wifi",
	value: "wxsz 无线设置 wuxianshezhi wifi 无线网 wuxianwang wx 密码 mm"
},
{ 	n:"外网设置", 
	s: "pppoe宽带拨号/dhcp/静态ip",
	a: 'set_network',
	value: 'wwsz 外网设置 waiwangshezhi network internet pppoe 拨号 bohao dhcp 静态ip jingtai 上网 shangwang'
},
{ 	n:"修改密码", 
	s: "建议修改系统默认密码(admin)",
	a: 'system_config',
...
{ 	n:"局域网 IP 地址", 
	...
	a:"options",
	p:"network/setup/lan",
	value: 'jyw 局域网 ip 地址 juyuwang dizhi'
},
{ 	n:"局域网 DHCP 服务", 
	s:"IP范围/IP MAC绑定", 
	a:"options",
	p:"network/setup/dhcp",
	value: 'jyw dhcp 租用时间 zuyongshijian mac绑定 macbangding'
},
{ 	n:"网络 MTU 设置", 
	s:"", 
	a:"options",
...
{ 	n:"PPP 高级设置", 
	...
	value: 'LCP请求发送间隔 lcpqingqiufasongjiange pppoe'
},
{ 	n:"MAC 地址克隆", 
	s:"设置外网接口mac地址", 
	a:"options",
	p:"network/setup/mac",
	value: 'mac地址克隆 macdizhikelong'
},
{ 	n:"UPNP 状态", 
	s:"列表", 
	a:"options",
...
{ 	n:"无线信道", 
	...
	value: 'wxxd 无线 信道 wuxianxindao 信号强度 xinhaoqiangdu 穿墙模式 chuanqiangmoshi'
},
{ 	n:"无线穿墙模式", 
	s:"调整无线信号强度", 
	a:"options",
...
{ 	n:"无线 MAC 访问控制", 
	...
	value: 'wx 无线 MAC 访问控制 强制断开可疑 duankaikeyishebei MAC地址 macdizhi 蹭网'
},
{ 	n:"系统时间管理", 
	s:"修改校准系统时间", 
	a:"options",
...
{ 	n:"路由器诊断", 
	...
	a:"options",
	p:"system/disk",
	value: 'lyqzd zd 路由器诊断 luyouqizhenduan 允许远程调试 yunxuyuanchengtiaoshi 存储状态 cunchuzhuangtai 路由器模式 luyouqimoshi'
},
{ 	n:"云插件", 
	s:"去广告/端口转发/SSH/MYDNS", 
	a:"cloud_guide",
	value: 'ycj cj 云插件 去广告 quguanggao 端口转发 duankouzhuanfa SSH MYDNS yunchajian yunpingtai yungongneng port"'
},
{ 	n:"网络诊断", 
	s:"DNS ping http 诊断", 
	a:"net_detect",
